...
export const GUIDE_SECTIONS: GuideSection[] = [
  ...
  // ── Section 3: 매도/청산 규칙 ──
  {
    ...
    content: {
      paragraphs: [
        '수익을 지키고 손실을 최소화하기 위해, 청산은 하드 룰(손절/트레일링) 우선 + 스코어링 보조 구조로 동작합니다.',
        '동적 ATR 손절: 고정 -3% 대신 시장 레짐별 배수를 적용합니다. 횡보 2.8배, 추세 2.2배, 변동성 폭발 2.5배로 즉시 전량 손절합니다.',
        '1차 익절(기본 40%): 스코어가 실효 임계치(횡보=기본, 추세=+4, 변동성=+2)를 넘더라도, 적응형 최소 수익률을 충족하고 품질 게이트(가격 ≥ BB 중앙선 또는 충분한 초과수익)를 통과해야 실행됩니다.',
        '1차 익절 후에는 스코어링 매도를 비활성화하고 트레일링 스탑만 사용합니다. 잔량은 max(고점-ATR×적응배수, 진입가×(1+min_profit_margin)) 조건에서 전량 정리됩니다.',
      ],
      tables: [
        {
          title: '청산 파이프라인',
          ...
          data: [
            ...
            { key: '2', stage: '1차 익절 후보', condition: 'exit_score ≥ 실효 임계치 + 적응형 최소수익률 충족 + 품질 게이트 통과', action: '보유 수량의 40% 매도' },
            { key: '3', stage: '트레일링 대기', condition: '1차 익절 이후', action: '스코어링 비활성, 트레일링만 모니터링' },
            { key: '4', stage: '2차 익절(잔량)', condition: '가격 ≤ max(고점-ATR×적응배수, 진입가×(1+min_profit_margin))', action: '남은 전량 매도' },
          ],
        },
      ],
      highlights: [
        '핵심은 조기 익절 억제 + 수익 잠금 강화입니다. 스코어 단독 청산 대신 품질 게이트와 트레일링 보호선을 결합해 손익비를 개선합니다.',
      ],
    },
  },
